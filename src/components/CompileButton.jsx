...
function CompileButton({ content, langauge, input, setOutput }) {
    ...
    return (
        <button 
            aria-label="Run Code" 
            className="flex items-center justify-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-xl" 
            disabled={processing} 
            onClick={compileCode}
        >
